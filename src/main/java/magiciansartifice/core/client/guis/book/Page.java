package magiciansartifice.core.client.guis.book;
...
//            gui.drawRect(x, y + 10, x + 111, y + 46, 325325);
    ...
    public static void addImageTextPage(GuiMagicBook gui, int x, int y, ItemStack item, ArrayList<String> text, float size)
    {
        y+=5;
    ...
    public static void addImageTextPage(GuiMagicBook gui, int x, int y, ItemStack item, ArrayList<String> text, float size, int txtX, int txtY, boolean showName, int imgX, int imgY)
    {
        y+=5;
    ...
    public static void addTextPage(GuiMagicBook gui, int x, int y, ArrayList<String> text)
    {
        y-=25;
        for(int i = 0; i < text.size(); i++) gui.getFont().drawString(text.get(i), x, y + 30 + i*12, 0);
        GL11.glColor4f(1, 1, 1, 1);
