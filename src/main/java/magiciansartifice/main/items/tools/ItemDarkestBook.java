...
public class ItemDarkestBook extends Item {

    public ItemDarkestBook() {
        this.setUnlocalizedName("evil.book");
    ...
    public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
        if (world.isRemote) {
            player.openGui(MagiciansArtifice.instance, GuiHandler.IDS.DarkestBook, world, 0, 0, 0);
        }
