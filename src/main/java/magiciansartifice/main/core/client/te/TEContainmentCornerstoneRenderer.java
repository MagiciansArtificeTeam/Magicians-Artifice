...
public class TEContainmentCornerstoneRenderer extends TileEntitySpecialRenderer{
    ...
    public void renderTileEntityAt(TileEntityContainmentCornerstone te, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        ...
        if (te != null) {
            if (te.hasWorldObj()) {
                ...
                if (this.containmentReady(x, y - 8, z, te.getWorldObj())) {
                    ...
                    System.err.println(this.containmentReady(x, y - 7, z, te.getWorldObj()));
                }
            } else {
                    System.err.println("World == " + te.hasWorldObj());
            }
        } else {
    ...
    private boolean containmentReady(int x, int y, int z, World world) {
        int x1 = x;
        int y1 = y;
        int z1 = z;
        {
